          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-400 text-sm">123 Fitness Avenue, Downtown, NY 10001</span>
              </li>
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+12345678900" className="text-gray-400 text-sm hover:text-gold transition-colors duration-300">
                  +1 (234) 567-8900
                </a>
              </li>
              <li className="flex items-center gap-3">
